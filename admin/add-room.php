...
if (strlen($_SESSION['hbmsaid'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		if (!in_array($extension, $allowed_extensions)) {
			...
			$sql = "insert into tblroom(RoomType,RoomName,MaxAdult,MaxChild,RoomDesc,NoofBed,Image,RoomFacility,hotel_type)values(:roomtype,:roomname,:maxadult,:maxchild,:roomdes,:nobed,:img,:roomfac,:hotel_type)";
...
?>
	...
	<head>
		<title>UNIVERSITY INN HOTEL | Add Room</title>
										...
										<div class="form-grids widget-shadow" data-example-id="basic-forms">
											...
											<div class="form-body">
												...
												<div class="form-group"> <label for="exampleInputEmail1">Select Campus</label> <select type="text" name="hotel_type" id="hotel_type" value="" class="form-control" required="true">
															...
															?>
																<option value="<?php echo htmlentities($row->hotel_id); ?>"><?php echo htmlentities($row->hotel_name); ?></option>
															<?php } ?>
