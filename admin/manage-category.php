...
{               ?>
                                    <tr>
                                       ...
                                       <td class="font-w600"><?php  echo htmlentities($row->Description);?></td>
                                          ...
                                          <td class="font-w600"><?php  echo htmlentities($row->Date);?></span>
                                        </td>
                                         <td class="font-w600"><a href="manage-category.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');">Delete</a></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
