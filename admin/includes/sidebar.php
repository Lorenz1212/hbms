    <div class="sidebar-menu">
      <header class="logo1">
        <img src="images/logoo.png" img align="center" width="100" height="100" />
      ...
      <div class="menu">
        <ul id="menu">
          ...
          <li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span> Room Category</span> <span class="fa fa-angle-right" style="float: right"></span></a>
          ...
          <li id="menu-academico"><a href="#"><i class="lnr lnr-layers"></i> <span>Facility</span> <span class="fa fa-angle-right" style="float: right"></span></a>
            <ul id="menu-academico-sub">
          ...
          <li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Page</span> <span class="fa fa-angle-right" style="float: right"></span></a>
            <ul id="menu-academico-sub">
          ...
          <li id="menu-academico"><a href="#"><i class="lnr lnr-book"></i> <span>Booking</span> <span class="fa fa-angle-right" style="float: right"></span></a>
            <ul id="menu-academico-sub">
          ...
          <li id="menu-academico"><a href="#"><i class="lnr lnr-book"></i> <span>Inquiry</span> <span class="fa fa-angle-right" style="float: right"></span></a>
            <ul id="menu-academico-sub">
              <li id="menu-academico-avaliacoes"><a href="read-enquiry.php">Read Inquiry</a></li>
              <li id="menu-academico-boletim"><a href="unread-enquiry.php">Unread Inquiry</a></li>
          ...
          <li id="menu-academico"><a href="#"><i class="fa fa-star-o"></i> <span>Star Rating</span> <span class="fa fa-angle-right" style="float: right"></span></a>
            <ul id="menu-academico-sub">

              <li id="menu-academico-boletim"><a href="view_star_rating.php">View Star Rating per Room</a></li>
