...
?>
	...
	<head>
		<title>UNIVERSITY INN HOTEL | New Booking</title>
											...
											<div class="form-body">
												...
												<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
													...
													<tbody>
														...
														where tblbooking.Status is null LIMIT $offset, $no_of_records_per_page";
														...
														if ($query->rowCount() > 0) {
															foreach ($results as $row) {               ?>
																<tr>
																	...
																	<td class="font-w600"><?php echo htmlentities($row->BookingDate); ?></span>
																	</td>
																	<?php if ($row->Status == "") { ?>
